multibranchPipelineJob('WHOAfroCKAN-build') {
    branchSources {
      branchSource {
        buildStrategies {
          buildChangeRequests {
        ...
        source {
          github {
              ...
              repoOwner('Fjelltopp')
              repository('who-afro-ckan')
              repositoryUrl("https://github.com/fjelltopp/who-afro-ckan.git")
  ...
  definition {
    ...
    cpsScm {
      scm {
        git {
          remote {
            url('git@github.com:fjelltopp/who-afro-ckan.git')
          ...
          scriptPath('jenkinsfiles/wac_deploy.groovy')
